...
$resultSet = $mysqli->query("SELECT * FROM `video`");
	$id = $_GET['id'];
	$single = $mysqli->query("SELECT * FROM `video` WHERE id = $id")->fetch_assoc();
		...
		<div class="col-sm-8 single-left">
			<div class="song">
				...
				<div class="video-grid">
					<video src="<?=$single['link']?>" controls width="650"></video>
				</div>
			</div>
			...
			<div class="published">
				...
				<div class="load_more">
					<ul id="myList">
						<li>
							<h4>Опубликована <?=date("d - m - Y" ,$single['upload_date']);?></h4>
			...
			<div class="single-grid-right">
				<div class="single-right-grids">
					<div class="col-md-4 single-right-grid-left">
						<a href="single.html"><img src="images/masl.JPG" alt="" /></a>
					</div>
					<div class="col-md-8 single-right-grid-right">
						<a href="single.html" class="title"> Масленица 2016</a>
						<p class="author"><a href="#" class="author">Бехзод Бабев</a></p>
						<p class="views">200 views</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="single-right-grids">
					<div class="col-md-4 single-right-grid-left">
						<a href="single.html"><img src="images/matv.JPG" alt="" /></a>
					</div>
					<div class="col-md-8 single-right-grid-right">
						<a href="single.html" class="title"> Председатель Совета Федерации Федерального Собрания РФ Валентина </a>
						<p class="author"><a href="#" class="author">Админ</a></p>
				...
				<div class="single-right-grids">
					<div class="col-md-4 single-right-grid-left">
						<a href="single.html"><img src="images/peace.JPG" alt="" /></a>
					</div>
					<div class="col-md-8 single-right-grid-right">
						<a href="single.html" class="title"> "Каждый в ответе за мир на планете" </a>
						<p class="author"><a href="#" class="author">Админ</a></p>
						<p class="views">2,114,200 views</p>
					</div>
					<div class="clearfix"> </div>
				...
				<div class="single-right-grids">
					<div class="col-md-4 single-right-grid-left">
						<a href="single.html"><img src="images/gumel.JPG" alt="" /></a>
					</div>
					<div class="col-md-8 single-right-grid-right">
						<a href="single.html" class="title"> Гумилевский клуб открыл туристический сезон</a>
						<p class="author"><a href="#" class="author">Админ</a></p>
						<p class="views">2,114,200 views</p>
					</div>
					<div class="clearfix"> </div>
